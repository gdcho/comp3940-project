        ...
        return (
            <section>
                ...
                <div className="px-7 my-10 text-gray-700 text-center">
                    <p>
                        S.A.M (Stories A Million) is an AI-driven platform
                        enabling users to craft limitless, unique narratives.
                        S.A.M places story creation at the fingertips of its
                        users. This fosters a collaborative environment where
                        creativity thrives, where anyone can write.
                    </p>
                </div>
                ...
                <div className="px-5 py-10 bg-gray-900 flex-row justify-around">
                    ...
                    <div className="mb-6 text-white tracking-tight">
                        ...
                        <p className="mb-4">
                            Add your creative story to others' stories or invite
                            others to contribute their stories to yours as well!
                        </p>
                        <Image
                    ...
                    <div className="mb-6 text-white tracking-tight">
                        ...
                        <p className="mb-4">
                            Let people decide which story is better by voting.
                            You can merge the story you like.
                        </p>
                ...
                <div className="px-7 text-gray-700 flex-row justify-center text-center">
                    ...
                    <p>
                        Utilizes the sophisticated mechanisms of an AI-driven
                        storytelling engine, powered by OpenAI's text-completion
                        GPT-4o model. The model transforms users' inputs into
                        vivid narratives, revealing the intelligent design and
                        cutting-edge algorithms that support endless creativity.
                    </p>
                </div>
