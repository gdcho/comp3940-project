        ...
        const options = {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    ...
                    {
                        role: "user",
                        content: `Given the summary: ${content}, and ${genre} continue the story by writing a paragraph of only three sentences.`,
                    },
                ],
                temperature: 1.0,
                max_tokens: 100,
